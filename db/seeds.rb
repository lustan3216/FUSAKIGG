...
Product.create( name:'電話單插座' ,item_name:'qt-41', v000_price:105 )
Product.create( name:'電話雙插座' ,item_name:'qt-42', v000_price:170 )
Product.create( name:'電話三插座' ,item_name:'qt-43', v000_price:170 )
Product.create( name:'網路單插座Cat.5e' ,item_name:'qt-815', v000_price:360 )
Product.create( name:'網路/電話組合插座Cat.5e' ,item_name:'qt-81415', v000_price:465 )
Product.create( name:'網路單插座Cat.6' ,item_name:'qt-816', v000_price:360 )
Product.create( name:'網路Cat.6/電話組合插座' ,item_name:'qt-81641', v000_price:465 )
Product.create( name:'電視單插座' ,item_name:'qt-tv1', v000_price:170 )
Product.create( name:'電視雙插座' ,item_name:'qt-tv2', v000_price:310 )
...
Product.create( name:'電話單插座' ,item_name:'fk-41', v000_price:105 )
Product.create( name:'電話雙插座' ,item_name:'fk-42', v000_price:170 )
Product.create( name:'電話三插座' ,item_name:'fk-43', v000_price:170 )
Product.create( name:'網路單插座Cat.5e' ,item_name:'fk-815', v000_price:360 )
Product.create( name:'網路/電話組合插座Cat.5e' ,item_name:'fk-81541', v000_price:465 )
Product.create( name:'網路單插座Cat.6' ,item_name:'fk-816', v000_price:360 )
Product.create( name:'網路Cat.6/電話組合插座' ,item_name:'fk-81641', v000_price:465 )
Product.create( name:'電視單插座' ,item_name:'fk-tv1', v000_price:170 )
Product.create( name:'電視雙插座' ,item_name:'fk-tv2', v000_price:310 )
Product.create( name:'紅色緊急接地單插座2.0線' ,item_name:'fk-3rr', v110_price:150 )
Product.create( name:'紅色緊急接地雙插座2.0絞線' ,item_name:'fk-6rr', v110_price:215 )

# FK蓋片 3
Product.create( name:'單連盲蓋片' ,item_name:'fk-4d', v000_price:30 )
Product.create( name:'雙連盲蓋片' ,item_name:'fk-5d', v000_price:60 )
...
# QT蓋片 3
Product.create( name:'單連盲蓋片' ,item_name:'qt-4d', v000_price:30 )
Product.create( name:'雙連盲蓋片' ,item_name:'qt-5d', v000_price:60 )
